...
- [x] Rebuild and verify the arm64 `1.0.3` release with `LSUIElement=true` and compiled `AppIcon.icns`.
...
- [x] QA readiness recorded for `1.0.3`: GREEN on commit `db43e2bdd20d891d72caba4c0ae1e07a28df680b` and binary SHA-256 `a724c6f555f8003c7b39012e92b0646610ea55150d5d2840bb1a9103182bc603`.
- [x] Product-manager readiness recorded for `1.0.3`: APPROVED on the same exact artifact.
